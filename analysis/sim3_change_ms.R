#-------------------------------Description----------------------------------
#Simulation how well using the multiple updates Urnings algorithm  based system can track
...
#-------------------------------------------------------------------------------
# saving the results
saveRDS(mse_change_res, "output/sim3_change_ms_mmse.rds")
saveRDS(result_list, "output/sim3_change_ms.rds")
